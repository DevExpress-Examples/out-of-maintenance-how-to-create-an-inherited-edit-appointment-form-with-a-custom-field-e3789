...
Namespace SchedulerInheritedAppointmentForm
	Public Class CustomAppointmentForm
		...
		Protected Friend Shadows ReadOnly Property Controller() As CustomAppointmentFormController
			Get
				Return DirectCast(MyBase.Controller, CustomAppointmentFormController)
			End Get
		End Property
...
'ORIGINAL LINE: this.tbPrice.EditValueChanged += new System.EventHandler(this.tbPrice_EditValueChanged);
			' 
			' labelControl1
			' 
